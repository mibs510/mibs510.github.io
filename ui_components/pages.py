...
from models import featured_books, get_user_by_username
from ui_components.layout import create_book_card, create_footer, create_header
...
def create_app_page(sign_out: Callable[[], None]) -> None:
